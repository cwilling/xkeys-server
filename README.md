...
_Xkeys-server_ package installers for end users will be available for Linux, MacOS & Windows. Prerelease installers are available for testing at the [Releases page](https://gitlab.com/chris.willing/xkeys-server/-/releases/0.9.6).
