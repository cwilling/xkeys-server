...
_Xkeys-server_ package installers for end users will be available for Linux, Raspberry Pi, Beaglebone Black, MacOS & Windows. Prerelease installers are available for testing at the [Releases page](https://gitlab.com/chris.willing/xkeys-server/-/releases/0.10.1).
